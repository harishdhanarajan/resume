...
def gradient(color1, color2, color3, content1, content2):
    st.markdown(f'<h1 style="text-align:center;background-image: linear-gradient(to right,{color1}, {color2});font-size:50px;border-radius:2%;">'
                ...
                f'<span style="color:white;font-size:18px;">{content2}</span></h1>', 
...
with col1:
    ...
    st.write("")
st.write(":orange[Hello! I'm an Eager learner with a strong interest in Artificial Intelligence and Machine Learning. Enthusiastic about diving into the field and gaining real-time experience with Phenomenal learning models like Bigram, GPTs and Deep Learning. Ready to contribute to innovative projects and eager to expand knowledge through dedicated learning and collaboration with experts in the field!]")
...
st.subheader("📊:rainbow[Individual Intivatives @ The Bank of New York]", divider='rainbow')
